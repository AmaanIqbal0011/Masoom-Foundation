    ...
    <ClerkProvider>
      <nav className="p-4 bg-background/50 sticky top-0 backdrop:blur border-b z-10">
        <div className="container mx-auto flex justify-between items-center">
          <Link href={"/"}>
            <div className="text-lg font-bold">Masoom Foundation</div>
          </Link>
          <div className="hidden md:flex space-x-4 items-center">
            ...
            <Link href="/donate" className="hover:font-bold transition-all duration-200">
              Donate
            </Link>
          ...
          <div className="md:hidden">
            ...
            <Sheet>
              ...
              <SheetContent>
                <SheetHeader>
                  <SheetTitle className="font-bold my-4">Masoom Foundation</SheetTitle>
                  <SheetDescription>
